...
public class Kayalar : Engel
{
    ...
    public Kayalar(int baslangic_x, int baslangic_y, int yukseklik, int genislik, int id, bool goruldu_mu) : base(baslangic_x, baslangic_y, yukseklik, genislik, id,  goruldu_mu)
    {
