...
public class Duvarlar : Engel
{
    ...
    public override Vector3 getVec()
    {
        return vec;
    }

    public override void setVec(Vector3 vec)
    {
        this.vec = vec;
    }
    ...
    public Duvarlar(int baslangic_x, int baslangic_y, int yukseklik, int genislik, int id, bool goruldu_mu) : base(baslangic_x, baslangic_y, yukseklik, genislik, id,  goruldu_mu)
    {
    ...
    public override int getBaslangic_x()
    {
        return baslangic_x;
    }
    public override int getBaslangic_y()
    {
        return baslangic_y;
    }
}